...
.middle-gray, .middle-gray-hover:hover {
  ...
  --x-gradient: var(--x-start-color), var(--x-middle-color), var(--x-end-color, #4b556300);
}

.middle-gray-dark, .middle-gray-dark-hover:hover {
  --x-middle-color: var(--x-gray-dark);
  --x-gradient: var(--x-start-color), var(--x-middle-color), var(--x-end-color, #1f293700);
}
...
.faded-top:after {
  ...
  background: linear-gradient(to top, #0000 0%, #0009 100%);
  top: 0;
}
...
.shadow, .shadow-hover:hover {
  box-shadow: 0 3px 3px -1px #0a16461a, 0 0 1px #0a16460f !important;
}

.shadow-1, .shadow-1-hover:hover {
  box-shadow: 0 1px 1px #0a16461a, 0 0 1px #0a16460f !important;
}

.shadow-2, .shadow-2-hover:hover {
  box-shadow: 0 6px 6px -1px #0a16461a, 0 0 1px #0a16460f !important;
}

.shadow-3, .shadow-3-hover:hover {
  box-shadow: 0 9px 9px -1px #0a16461a, 0 0 1px #0a16460f !important;
}

.shadow-4, .shadow-4-hover:hover {
  box-shadow: 0 16px 16px -1px #0a16461a, 0 0 1px #0a16460f !important;
}

.shadow-5, .shadow-5-hover:hover {
  box-shadow: 0 32px 40px -2px #0a16461a, 0 0 1px #0a16460f !important;
}

.shadow-6, .shadow-6-hover:hover {
  box-shadow: 0 36px 50px #0a16461a, 0 0 1px #0a16460f !important;
}

.shadow-inset, .shadow-inset-hover:hover {
  box-shadow: inset 0 1px 2px #00000013 !important;
}

.shadow-outline, .shadow-outline-hover:hover, .shadow-focus, .shadow-focus-hover:hover {
  box-shadow: 0 0 0 3px #4299e180 !important;
}
...
.border-opacity-0, .border-opacity-0-hover:hover {
  --x-border-opacity: 0;
}
...
.shadow-soft-1, .shadow-soft-1-hover:hover {
  box-shadow: 0 1px 1px #0a16460a !important;
}

.shadow-soft-2, .shadow-soft-2-hover:hover {
  box-shadow: 0 6px 6px -1px #0a16460a !important;
}

.shadow-soft-3, .shadow-soft-3-hover:hover {
  box-shadow: 0 9px 9px -1px #0a16460a !important;
}

.shadow-soft-4, .shadow-soft-4-hover:hover {
  box-shadow: 0 16px 16px -1px #0a16460a !important;
}

.shadow-soft-5, .shadow-soft-5-hover:hover {
  box-shadow: 0 32px 40px -2px #0a16460a !important;
}

.shadow-soft-6, .shadow-soft-6-hover:hover {
  box-shadow: 0 36px 50px #0a16460a !important;
}
...
/*# sourceMappingURL=index.0eefb65b.css.map */
